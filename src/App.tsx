...
function App() {
  return (
    <div className="App">
      <NavComponent />
      <div className="icon_wrapper">   <FaReact size={sizeIcon} className="icon" color={"#61dafb"} /><span className="fa"> <IoLogoJavascript size={sizeIcon} color={"#EFD81D"} /></span>
